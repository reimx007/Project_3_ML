...
CREATE TABLE home_sale_predicted (
ID INT PRIMARY KEY,
Unnamed TEXT,
Alaska INT, 
Alabama INT,
...
select * from home_sale_predicted;
...
FROM '--USE FILEPATH FROM PREDICTED DATA HERE--' DELIMITER ',' CSV HEADER;